   ...
   <div id="wrapper">
      ...
      <div id="main">
         <div class="inner">
            ...
            <!-- Header -->
            <header id="header">
               <button style="width: 120px; position: absolute; text-align: center; margin-left: 1020px; margin-bottom: 50px"
                  onclick="location.href='main0426.jsp'">로그아웃</button>
               <ul class="icons">
                  ...
                  <li><span><%=vo.getM_name() %> 님 환영합니다.</span></li>
               </ul>
            </header>
