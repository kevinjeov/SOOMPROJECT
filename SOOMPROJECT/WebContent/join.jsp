					...
					<div class="row">
						<div class="small-12 medium-2 large-2 columns">
							...
							<div class="p-image"  id="image_container">
								...
								<input class="file-upload" type="file" accept="image/*" onchange="setThumbnail(event);"/>
									<br>
									<br>
									...
									
									{
										...
										document.querySelector("div.circle").appendChild(img); }; 
