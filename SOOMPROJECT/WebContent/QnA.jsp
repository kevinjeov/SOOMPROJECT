      ...
      <div id="main">
         <div class="inner" style="background: white;">
            ...
            <section id="QnA">
               ...
               <div class="textbox">
                  <label for="ex_input">제목</label> <input type="text" id="ex_input">
               </div>
               <br> <br>
               <div class="textbox">
                  <label for="ex_input">문의 내용</label> <input type="text"
                     id="ex_input" style="height: 400px">
               </div>
               <br>
               <div style="text-align: center;">
                  <input type="submit" style="align-content: center; width: 10%;">
               </div>
            </section>
